...
function TextField(props){return(
  <input {...props}
    className={"w-full px-3 py-2 rounded-lg border " + (props.className||"")}
  />
);}
...
export default function TherapistsPage(){
  ...
  async function remove(id){
    if(!confirm("Delete this therapist profile? Bookings keep history.")) return;
  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="bg-white border rounded-2xl p-4">
        ...
        <div className="grid grid-cols-1" style={{rowGap: '12px'}}>
      ...
      <div className="bg-white border rounded-2xl overflow-hidden">
        <div className="px-4 py-3 border-b bg-gray-100 font-medium">All therapists</div>
              ...
              <tr key={t.id} className="border-t">
                ...
                <td className="px-4 py-2">
                  <div className="flex gap-2">
                    ...
                    <button onClick={()=>remove(t.id)} className="px-2 py-1 border rounded-lg" style={{borderColor:'#fecaca', color:'#b91c1c'}}>
                      Delete
                    </button>
                  </div>
                </td>
