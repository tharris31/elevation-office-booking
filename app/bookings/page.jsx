...
export default function BookingsPage(){
  ...
  async function createBookingModal(){
    ...
    for(let i=0;i<count;i++){
      ...
      const conflict = (sameRoom||[]).some(b=>{
  ...
  return (
    <div className="grid gap-6">
      ...
      {/* Filters */}
      <RowCard>
        <div className="grid" style={{gridTemplateColumns:'repeat(5, minmax(0,1fr))', gap:'12px', alignItems:'end'}}>
          <div>
      ...
      <RowCard>
        ...
        {days.map((d,idx)=>(
          <div key={idx} className="mb-6">
            ...
            <div className="grid" style={{rowGap:'8px'}}>
                        ...
                        return (
                          <div key={b.id} className="px-2 py-1 rounded-lg shadow-sm text-xs"
                            ...
                            <span className="ml-2">
                              ...
                              {b.series_id && <button onClick={()=>deleteBooking(b,true)} className="ml-2" style={{color:'#b91c1c'}}>Delete series</button>}
                            </span>
                          </div>
                        );
                      })}
